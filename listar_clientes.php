        ...
        ?>
                <div class="row text-center p-1">
                    ...
                    <div class="col-2 icones"> 
                        <a href="ver_cliente.php?id=<?php echo $id?>"><img src="img/ver.png"></a> 
                        <a href="editar_cliente.php?id=<?php echo $id?>"><img src="img/editar.png"></a>
                        <a href="excluir_cliente.php?id=<?php echo $id?>" onclick="return confirm('Confirma a Exclusão do Registro?')"><img src="img/delete.png"></a>
                    </div>
                </div>
        <?php
            }
